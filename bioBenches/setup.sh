#!/bin/bash
# Build script for Layer 1c: Bio Base Image (bio-bench-base)
...
STATE_KEY="$(family_base_state_key bio)"
LEGACY_STATE_KEY="$(legacy_family_base_state_key bio)"
BASE_IMAGE="$(family_base_image bio)"
