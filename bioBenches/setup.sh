...
echo "=========================================="
echo "Building Layer 1c: BioBenches Base"
echo "=========================================="
echo ""
echo "Configuration:"
...
if [ "$rebuild" -eq 1 ]; then
    if [ "$FORCE_REBUILD" -eq 1 ]; then
        echo "Forcing rebuild of biobench-base:$USERNAME..."
    elif [ "$image_exists" -eq 0 ]; then
        echo "biobench-base:$USERNAME not found. Building..."
    else
        echo "Detected base-image changes. Rebuilding biobench-base:$USERNAME..."
    fi
    ...
    echo "biobench-base:$USERNAME is up to date."
fi
