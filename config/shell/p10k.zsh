# Generated by Powerlevel10k configuration wizard on 2025-10-01 at 05:21 -04.
...
() {
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_DIR_PREFIX="${WAVETERM_CONTAINER_NAME:+$WAVETERM_CONTAINER_NAME}"
