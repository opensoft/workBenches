...
This document applies to the **legacy monolithic .devcontainer** build and is deprecated. The current standard is the layered image system (`workbench-base` → `dev-bench-base` → `cpp-bench`). Keep this for historical reference only.
