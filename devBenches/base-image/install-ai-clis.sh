...
#   - Other AI CLIs (Claude Code, Codex, Gemini, Copilot, etc.)
#
...
if ! run_with_timeout "$COMMAND_TIMEOUT" "Claude Code npm install" npm install -g @anthropic-ai/claude-code; then
